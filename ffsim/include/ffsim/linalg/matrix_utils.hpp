...
inline bool array_all_close(
    const MatrixXcd &mat1, const MatrixXcd &mat2, double rtol = 1e-5, double atol = 1e-8
)
{
...
inline bool
is_real_symmetric(const MatrixXcd &mat, double rtol = 1e-5, double atol = 1e-8)
{
